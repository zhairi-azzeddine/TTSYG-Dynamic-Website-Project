...
<head>
  ...
  <title>Troupe Théâtre S.Y.G - About</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="box-item col-md-4">
            <div class="flip-box">
              <div class="flip-box-front text-center" style="background-image: url('assets/img/breadcrumbs-bg.jpg');">
                <div class="inner color-white">
                  <h3 class="flip-box-header"> <img height="100" src="assets/img/logo/logomin.png"></h3>
                  <h3>Les Spectacle.</h3>
                  <img src="https://s25.postimg.cc/65hsttv9b/cta-arrow.png" class="flip-box-img" alt="">
                </div>
              </div>
              <div class="flip-box-back text-center" style="background-image: url('https://s25.postimg.cc/frbd9towf/cta-2.png');">
                <div class="inner color-white">
                  <h3 class="flip-box-header">22 Spectacles</h3>
                  <p>Le lorem ipsum est, en imprimerie, une suite de mots sans signification.</p>
                  <button class="flip-box-button">voir plus</button>
                </div>
              </div>
            </div>
          </div>
